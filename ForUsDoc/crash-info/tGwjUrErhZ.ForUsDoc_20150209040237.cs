...
PID: 12209
Date: 2015-02-09 04:02:37(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12209, uid 5000)

Register Information
r0   = 0x114604b0, r1   = 0x00000000
r2   = 0x0026b618, r3   = 0x00000000
r4   = 0xb261d658, r5   = 0xb4e90901
r6   = 0xbedd4924, r7   = 0x004c2d78
r8   = 0xbedd4940, r9   = 0x000aed78
r10  = 0x114604b0, fp   = 0xbedd4a88
ip   = 0xb6bd1000, sp   = 0xbedd48d0
lr   = 0xb25c9b13, pc   = 0xb25ad798
cpsr = 0x60000030
...
000dc000 00990000 rw-p [heap]
b1c56000 b1c5b000 r-xp /usr/lib/libhaptic-module.so
b245b000 b246c000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2475000 b247a000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24af000 b24b2000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24ba000 b24bb000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24c3000 b24cd000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24f9000 b250d000 r-xp /usr/lib/libnetwork.so.0.0.0
b2516000 b252a000 r-xp /usr/lib/libwifi-direct.so.0.0
b2532000 b253a000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b253b000 b2544000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b254c000 b2611000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b261f000 b2628000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2631000 b2647000 r-xp /opt/usr/apps/tGwjUrErhZ/bin/ForUsDoc.exe
...
Callstack Information (PID:12209)
Call Stack Count: 45
 0: (0xb25ad798) [/usr/lib/osp/libosp-net.so.1] + 0x61798
 1: Tizen::Net::Sockets::_SocketImpl::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x3a (0xb25c9b13) [/usr/lib/osp/libosp-net.so.1] + 0x7db13
 2: Tizen::Net::Sockets::Socket::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x1a (0xb25c47b7) [/usr/lib/osp/libosp-net.so.1] + 0x787b7
 3: Enrollment::SendData() + 0x304 (0xb2639758) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x8758
 4: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x488 (0xb263931c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x831c
 5: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26398ac) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x88ac
End of Call Stack
