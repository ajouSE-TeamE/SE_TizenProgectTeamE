...
PID: 8346
Date: 2015-02-09 03:17:37(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 8346, uid 5000)

Register Information
r0   = 0xbedd4ab4, r1   = 0x00000006
r2   = 0x00000000, r3   = 0x00195138
r4   = 0xbedd4a98, r5   = 0xbedd4ab4
r6   = 0x00000010, r7   = 0x00000006
r8   = 0xb3d2ed70, r9   = 0x000aec20
r10  = 0xb4413940, fp   = 0xbedd4c68
ip   = 0x0046f0d0, sp   = 0xbedd4a90
lr   = 0xb4227d7f, pc   = 0xb385d52a
cpsr = 0x60000030
...
Callstack Information (PID:8346)
Call Stack Count: 43
 0: (0xb385d52a) [/usr/lib/osp/libosp-uifw.so] + 0x49152a
 1: Tizen::Ui::Controls::CheckButton::SetText(Tizen::Base::String const&) + 0x18 (0xb3731775) [/usr/lib/osp/libosp-uifw.so] + 0x365775
 2: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x100 (0xb2639c90) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x7c90
 3: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb263a568) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x8568
End of Call Stack
