...
PID: 14260
Date: 2014-12-10 01:17:59(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 14260, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbea7cbf0
r2   = 0x00000006, r3   = 0x00000016
r4   = 0xb26e7374, r5   = 0xbea7cbf0
r6   = 0x00252470, r7   = 0x001c02b0
r8   = 0xbea7cd80, r9   = 0x000a86f8
...
Callstack Information (PID:14260)
Call Stack Count: 43
 ...
 2: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x298 (0xb26e6c70) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x7c70
