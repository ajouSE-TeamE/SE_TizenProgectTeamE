...
PID: 8668
Date: 2015-02-09 03:23:53(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 8668, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbedd4c38
r2   = 0x00000006, r3   = 0x00000016
r4   = 0xb263a750, r5   = 0xbedd4c38
r6   = 0x00367de0, r7   = 0x00269690
r8   = 0xbedd4d80, r9   = 0x000aec18
r10  = 0xb4413940, fp   = 0xbedd4c68
ip   = 0xb373175d, sp   = 0xbedd4ad8
lr   = 0xb3731765, pc   = 0xb385cf18
cpsr = 0x60000030
...
Callstack Information (PID:8668)
Call Stack Count: 43
 0: (0xb385cf18) [/usr/lib/osp/libosp-uifw.so] + 0x490f18
 1: Tizen::Ui::Controls::CheckButton::SetText(Tizen::Base::String const&) + 0x8 (0xb3731765) [/usr/lib/osp/libosp-uifw.so] + 0x365765
 2: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x100 (0xb2639eb4) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x7eb4
 3: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb263a78c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x878c
End of Call Stack
