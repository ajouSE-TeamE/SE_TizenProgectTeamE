...
PID: 10267
Date: 2015-02-09 03:33:58(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 10267, uid 5000)

Register Information
r0   = 0xbedd4908, r1   = 0x00000041
r2   = 0x00000000, r3   = 0x00000000
r4   = 0xb261e658, r5   = 0xbedd4908
r6   = 0xbedd4924, r7   = 0x00305948
r8   = 0xbedd4940, r9   = 0x00000041
r10  = 0x00344670, fp   = 0xbedd4a88
ip   = 0xb69e2b98, sp   = 0xbedd48d0
lr   = 0xb4226583, pc   = 0xb25cab26
cpsr = 0x40000030
...
Callstack Information (PID:10267)
Call Stack Count: 44
 0: Tizen::Net::Sockets::_SocketImpl::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x4d (0xb25cab26) [/usr/lib/osp/libosp-net.so.1] + 0x7db26
 1: Tizen::Net::Sockets::Socket::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x1a (0xb25c57b7) [/usr/lib/osp/libosp-net.so.1] + 0x787b7
 2: Enrollment::SendData() + 0x304 (0xb263a758) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x8758
 3: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x488 (0xb263a31c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x831c
 4: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb263a8ac) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x88ac
End of Call Stack
