...
PID: 20377
Date: 2014-12-10 05:38:48(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 20377, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x00229d00, r3   = 0x00000000
r4   = 0xb26c9658, r5   = 0x00000000
r6   = 0xbea7c924, r7   = 0x002387d8
r8   = 0xbea7c940, r9   = 0x000a8ae8
r10  = 0xb44bf940, fp   = 0xbea7ca88
ip   = 0xb6c7d000, sp   = 0xbea7c8d0
lr   = 0xb2675b0d, pc   = 0xb26598c8
cpsr = 0x60000030
...
000dc000 00a3a000 rw-p [heap]
b1d02000 b1d07000 r-xp /usr/lib/libhaptic-module.so
b2507000 b2518000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2521000 b2526000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b255b000 b255e000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2566000 b2567000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b256f000 b2579000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b25a5000 b25b9000 r-xp /usr/lib/libnetwork.so.0.0.0
b25c2000 b25d6000 r-xp /usr/lib/libwifi-direct.so.0.0
b25de000 b25e6000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b25e7000 b25f0000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b25f8000 b26bd000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b26cb000 b26d4000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b26dd000 b26f3000 r-xp /opt/usr/apps/tGwjUrErhZ/bin/ForUsDoc.exe
...
Callstack Information (PID:20377)
Call Stack Count: 45
 0: (0xb26598c8) [/usr/lib/osp/libosp-net.so.1] + 0x618c8
 1: Tizen::Net::Sockets::_SocketImpl::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x34 (0xb2675b0d) [/usr/lib/osp/libosp-net.so.1] + 0x7db0d
 2: Tizen::Net::Sockets::Socket::SendTo(Tizen::Base::ByteBuffer&, Tizen::Net::NetEndPoint const&) + 0x1a (0xb26707b7) [/usr/lib/osp/libosp-net.so.1] + 0x787b7
 3: Enrollment::SendData() + 0x304 (0xb26e55c8) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x85c8
 4: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x488 (0xb26e517c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x817c
 5: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26e571c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x871c
End of Call Stack
