...
PID: 13272
Date: 2015-02-09 04:05:52(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13272, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x0033ffa8, r3   = 0x00000000
r4   = 0xb261d658, r5   = 0x00000000
r6   = 0xbedd4924, r7   = 0x0022c7f8
r8   = 0xbedd4940, r9   = 0x000aed08
...
Callstack Information (PID:13272)
Call Stack Count: 45
 ...
 3: Enrollment::SendData() + 0x304 (0xb26395c8) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x85c8
 4: Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x488 (0xb263918c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x818c
 5: non-virtual thunk to Enrollment::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb263971c) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0x871c
End of Call Stack
