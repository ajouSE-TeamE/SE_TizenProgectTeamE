...
PID: 11078
Date: 2015-02-09 03:40:18(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 11078, uid 5000)

Register Information
r0   = 0xbedd45b0, r1   = 0x00000000
r2   = 0x00400344, r3   = 0xbedd45b0
r4   = 0xbedd45b0, r5   = 0xb26443a0
r6   = 0xffff4a1d, r7   = 0x00389468
r8   = 0xbedd4994, r9   = 0x00000000
r10  = 0xbedd4894, fp   = 0xbedd4638
ip   = 0xb42221b5, sp   = 0xbedd4200
lr   = 0xb263c290, pc   = 0xb42221b8
cpsr = 0x60000030
...
Callstack Information (PID:11078)
Call Stack Count: 49
 0: Tizen::Base::Character::ToString() const + 0x3 (0xb42221b8) [/usr/lib/osp/libosp-appfw.so] + 0x12b1b8
 1: Enrollment::OnSceneActivatedN(Tizen::Base::String const&, Tizen::Base::String const&, Tizen::Base::Collection::IList*) + 0x594 (0xb263c290) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0xb290
 2: non-virtual thunk to Enrollment::OnSceneActivatedN(Tizen::Base::String const&, Tizen::Base::String const&, Tizen::Base::Collection::IList*) + 0x4c (0xb263cf70) [/opt/apps/tGwjUrErhZ/bin/ForUsDoc.exe] + 0xbf70
End of Call Stack
